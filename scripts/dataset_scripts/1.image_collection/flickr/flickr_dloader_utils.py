...
def download_flickr_img_by_group(group_name, pagenum = None, show_log = False, start_date = None, end_date = None):
...
def download_flickr_img(photos, download_dir='/disks/data/datasets/dloaded/', 
                        im_size = 'c', max_num = None, show_log = False, worker_id = None, max_retry_count = 1):
    """
